 ...
 */
package fr.ninedocteur.ninetylib.integrations.discord;

import fr.ninedocteur.ninetylib.integrations.discord.entities.*;
import fr.ninedocteur.ninetylib.integrations.discord.entities.pipe.Pipe;
import fr.ninedocteur.ninetylib.integrations.discord.entities.pipe.PipeStatus;
import fr.ninedocteur.ninetylib.integrations.discord.exceptions.NoDiscordClientException;
import fr.ninedocteur.ninetylib.integrations.discord.entities.Callback;
...
public final class IPCClient implements Closeable
{
    ...
    public void sendRichPresence(RichPresence presence, Callback callback, boolean log)
    {
        ...
        pipe.send(Packet.OpCode.FRAME, command, callback);
    }
